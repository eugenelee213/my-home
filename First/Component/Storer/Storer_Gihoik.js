...
import {Platform, StyleSheet,ScrollView,Text, View,Picker,AppRegistry, Image, TouchableOpacity} from 'react-native';
    ...
    return (
      ...
      <ScrollView style={{flexDirection:'column',}}>
                ...
                <View style={{width:'100%'}}>
                   <TouchableOpacity onPress={()=> this.props.navigation.navigate('Gihoik_detailScreen')}>
