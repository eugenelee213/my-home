    ...
    return (
      <ScrollView style={{ flexDirection:'column',flex:1,}}>
        ...
        <View style={{flexDirection:'row',height:50}}>
          ...
          <Text style={styles.welcome}>       튜닝용품   </Text>
        ...
        <View style={{flexDirection:'row',height:50,width:'100%'}}>
          <Icon2 style={{width:'20%',textAlign: 'center',}} name="android" size={30} color="blue" justifyContent= "center" alignItems= "center" />
          <Icon2 style={{width:'20%',textAlign: 'center',}} name="android" size={30} color="blue" justifyContent= "center" alignItems= "center"/>
          <Icon2 style={{width:'20%',textAlign: 'center',}} name="android" size={30} color="blue" justifyContent= "center" alignItems= "center"/>
          <Icon2 style={{width:'20%',textAlign: 'center',}} name="android" size={30} color="blue" justifyContent= "center" alignItems= "center"/>
          <Icon2 style={{width:'20%',textAlign: 'center',}} name="android" size={30} color="blue" justifyContent= "center" alignItems= "center"/>
        ...
        <View style={{flexDirection:'row',height:50,margin:5}}>
          ...
          <Text style={{margin:5,fontSize:20,color:'black'}}>전체 7,556</Text>
          <View style={{ flexDirection:'row',alignItems: "center",width:'100%'}}>

                <View style={{ flexDirection:'column',alignItems: "center",width:'30%',marginTop:1,marginLeft:10,marginRight:5}}>
                    <TouchableOpacity onPress={()=> this.props.navigation.navigate('Storer_Sale_detailScreen')}>
                ...
                <View style={{ flexDirection:'column',alignItems: "center",width:'30%',marginTop:1,marginLeft:10,marginRight:5}}>
                    <TouchableOpacity onPress={()=> this.props.navigation.navigate('Storer_Sale_detailScreen')}>
                       <Image source={require('../../assets/images/02.jpg')} style={{width:100,height:100,}}/>
                    </TouchableOpacity>
                ...
                <View style={{ flexDirection:'column',alignItems: "center",width:'30%',marginTop:1,marginLeft:10,marginRight:5}}>
                    <TouchableOpacity onPress={()=> this.props.navigation.navigate('Storer_Sale_detailScreen')}>
                       <Image source={require('../../assets/images/03.jpg')} style={{width:100,height:100,}}/>
                    </TouchableOpacity>
