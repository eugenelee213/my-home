    ...
    return (
      <ScrollView style={{ flexDirection:'column',flex:1}}>
            ...
            <View style={{ flexDirection:'row',alignItems: "center",width:'100%'}}>
                ...
                <Text style={{color:'black',fontSize:11 ,alignItems: "center",width:110,marginTop:5,marginLeft:10,marginRight:5,marginBottom:5,}}>오토반 비트윈 업충전거치 집안용 멀티포켓 … </Text>
                <View style={{flexDirection:'row',alignItems: "center",width:110,marginTop:5,marginLeft:10,marginRight:5,marginTop:5,}}>
