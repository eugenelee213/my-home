			...
			<View style={styles.container}>
				<Image
					...
					style={[
						{
							borderRadius: 8,
							width: this.props.variant ? fullWidth / 2 - 30 : fullWidth/3 - 30,
							height: this.props.variant ? 170 : 120,
							margin: this.props.variant ? 0 : 0
						}
					]}
				/>
				...
				<Text
					style={[
						{
							paddingTop: this.props.variant ? 10 : 8,
							paddingBottom: this.props.variant ? 5 : 5,
							color: '#363636',
							fontSize: this.props.variant ? 15 : 12
						}
					]}
				>
					{this.props.name}
